...
public class SimVmSchedulerTimeSharedOverSubscription extends
		VmSchedulerTimeSharedOverSubscription {

	public SimVmSchedulerTimeSharedOverSubscription(List<? extends Pe> pelist) {
		super(pelist);
	...
	protected boolean allocatePesForVm(String vmUid, List<Double> mipsShareRequested) {
		...
		for (Double mips : mipsShareRequested) {
			//Log.printLine("vmUid " + vmUid + " mipsShareRequested "+mipsShareRequested);
			if (mips > peMips) {
