...
public class SimProgressCloudletSchedulerDynamicWorkloadReservation extends
SimProgressCloudletSchedulerDynamicWorkload {

	public SimProgressCloudletSchedulerDynamicWorkloadReservation(double mips,
			int numberOfPes, CloudletCpuAllocator cpuAllocator, CloudletRamAllocator ramAllocator,
			CloudletIoAllocator ioAllocator, CloudletBwAllocator bwAllocator) {
	...
	@Override
	protected boolean checkAllocatedReasourcesForCloudlet(ResCloudlet rcl) {
